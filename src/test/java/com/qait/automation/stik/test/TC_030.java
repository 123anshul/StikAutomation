...
public class TC_030 {
	...
	//Beginning of original code written according to new user and /professional workflow
...
*///end of original code written according to new user and /professional workflow
	...
	public void D_Verify_Referral_Page_Again()  {
		...
		assert test.verifyReferralSupporter(test.getYamlVal("referralPage.userNameOfSupporter_temp"));
